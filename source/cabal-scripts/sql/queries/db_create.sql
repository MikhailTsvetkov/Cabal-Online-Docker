CREATE DATABASE [<DB_NAME>]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'<DB_NAME>', FILENAME = N'/var/opt/mssql/data/<DB_NAME>.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'<DB_NAME>_log', FILENAME = N'/var/opt/mssql/data/<DB_NAME>_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
